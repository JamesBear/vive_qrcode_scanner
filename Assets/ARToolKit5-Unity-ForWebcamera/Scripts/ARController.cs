...
public class ARController : MonoBehaviour
{
	...
	public Color[] _videoColorArray0 = null; // An array used to fetch pixels from the native side, only if not using native GL texturing.
	public Color32[] _videoColor32Array0 = null; // An array used to fetch pixels from the native side, only if not using native GL texturing.
	...
	public Color[] _videoColorArray1 = null; // An array used to fetch pixels from the native side, only if not using native GL texturing.
	public Color32[] _videoColor32Array1 = null; // An array used to fetch pixels from the native side, only if not using native GL texturing.
	public Texture2D _videoTexture1 = null;  // Texture object with the video image.
...
//    	AR_MATRIX_CODE_GLOBAL_ID = 2830
	...
	private GameObject CreateVideoBackgroundMesh(int index, int w, int h, int layer, out Color[] vbca, out Color32[] vbc32a, out Texture2D vbt, out Material vbm)
	{
        ...
        var pos = vbmgo.transform.localPosition;
        pos.z = 3.19f;
        vbmgo.transform.position = pos;
